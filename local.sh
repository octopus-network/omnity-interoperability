...
$ dfx canister call omnity_hub execute_proposal '( vec {variant { AddToken = record { decimals = 18 : nat8; icon = opt "rune.logo.url"; token_id = "102:1"; issue_chain = "Bitcoin"; symbol = "FIRST•RUNE•TOKEN"; dst_chains = vec {"cosmoshub";}}}})'
