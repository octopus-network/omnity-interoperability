...
let transfer_memory_increase = sub(current_memory_size,init_memory_size);
...
output(file, stringify("> *  memory increase: ",transfer_memory_increase, "\n"));
...
let svg = stringify("Transfer-", $timestamp,".svg");
