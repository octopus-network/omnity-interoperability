...
use crate::ic_sui::fastcrypto::encoding::Hex;
...
impl SerializeAs<crate::ic_sui::sui_types::base_types::SequenceNumber> for SequenceNumber {
    fn serialize_as<S>(
        value: &crate::ic_sui::sui_types::base_types::SequenceNumber,
        serializer: S,
    ) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
...
impl<'de> DeserializeAs<'de, crate::ic_sui::sui_types::base_types::SequenceNumber>
    for SequenceNumber
{
    fn deserialize_as<D>(
        deserializer: D,
    ) -> Result<crate::ic_sui::sui_types::base_types::SequenceNumber, D::Error>
    where
        D: Deserializer<'de>,
    {
        let b = BigInt::deserialize(deserializer)?;
        Ok(crate::ic_sui::sui_types::base_types::SequenceNumber::from_u64(*b))
    }
}
