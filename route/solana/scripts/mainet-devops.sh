...
########################### update token via solana route diretly
...
########################## update Bitcoin-runes-DOG•GO•TO•THE•MOON via hub
# SOL_CHAIN_ID="eSolana"
...
# query token info via hub
token_id="Bitcoin-runes-DOG•GO•TO•THE•MOON"
dfx canister call $HUB_CANISTER_ID get_tokens "(null, opt \"$token_id\",0:nat64,36:nat64)" --ic

# query token info via soalna route
token_id="Bitcoin-runes-DOG•GO•TO•THE•MOON"
dfx canister call $SOLANA_ROUTE_CANISTER_ID get_token "( \"$token_id\")" --ic


TOKEN_ID="Bitcoin-runes-DOG•GO•TO•THE•MOON"
TOKEN_NAME="DOG•GO•TO•THE•MOON"
TOKEN_SYMBOL="🐕"
DECIMALS=5
ICON="https://raw.githubusercontent.com/octopus-network/omnity-token-imgs/main/metadata/moon_dog_meta.json"
