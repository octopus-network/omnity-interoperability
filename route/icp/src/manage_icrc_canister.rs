...
pub async fn stop_icrc_ledger(icrc_ledger_id: Principal) -> CallResult<((),)> {
...
pub async fn start_icrc_ledger(icrc_ledger_id: Principal) -> CallResult<((),)> {
    let args = CanisterIdRecord {
        canister_id: icrc_ledger_id,
    };
...
pub async fn delete_icrc_canister(icrc_ledger_id: Principal) -> CallResult<((),)> {
    let args = CanisterIdRecord {
        canister_id: icrc_ledger_id,
    };
...
pub async fn icrc_canister_status(icrc_ledger_id: Principal) -> CallResult<(CanisterStatusResponse,)> {
    let args = CanisterIdRecord {
        canister_id: icrc_ledger_id,
    };
