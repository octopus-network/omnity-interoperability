...
impl EvmRouteState {
    pub fn init(args: InitArgs) -> anyhow::Result<Self> {
        ...
        let ret = EvmRouteState {
            ...
            lightclient_verify_requests: Default::default(),
            lightclient_verify_result: Default::default(),
...
pub struct EvmRouteState {
    ...
    #[serde(default)]
    pub lightclient_verify_requests: BTreeMap<String, TicketVerifyRecord>,
    #[serde(default)]
    pub lightclient_verify_result: BTreeMap<String, Result<(), String>>,
...
pub fn default_rpcs_count() -> usize {
    1usize
}
